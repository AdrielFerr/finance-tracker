...
@section('page-title', 'Novo Método')
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white shadow rounded-lg" x-data="paymentMethodForm()">
        <div class="px-6 py-5 border-b border-gray-200">
            <h3 class="text-lg font-medium text-gray-900">Adicionar Método de Pagamento</h3>
            <p class="mt-1 text-sm text-gray-500">Cartão, PIX, dinheiro ou outro método</p>
        </div>

        <form action="{{ route('payment-methods.store') }}" method="POST" class="px-6 py-5 space-y-6">
            @csrf
                    ...
                    <div class="rounded-xl shadow-lg overflow-hidden" 
                        ...
                        <div class="p-6 text-white">
                            <div class="flex items-center justify-between mb-6">
                                ...
                                <span class="px-2 py-1 text-xs font-semibold rounded-full bg-white bg-opacity-20">Ativo</span>
                            </div>
                            <h3 class="text-xl font-bold mb-4">Novo Método</h3>
                            <p class="text-sm font-mono tracking-wider">•••• •••• •••• ••••</p>
                        </div>
                    </div>
                </div>
            </div>
...
function paymentMethodForm() {
    return {
        selectedType: '{{ old('type', 'credit_card') }}',
